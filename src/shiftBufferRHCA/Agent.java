package shiftBufferRHCA;

import core.game.StateObservation;
import core.game.StateObservationMulti;
import core.player.AbstractMultiPlayer;
import ontology.Types;
import shiftBufferRHCA.rhAlgo.search.RHCA;
import shiftBufferRHCA.evodef.EvoAlg;
import shiftBufferRHCA.evodef.GameActionSpaceAdapter;
import shiftBufferRHCA.evodef.GameActionSpaceAdapterMulti;
...
//    }
    ...
    public Agent(StateObservationMulti so, ElapsedCpuTimer elapsedTimer, int playerID) {
        ...
        this.evoAlg = new RHCA(nResamplings, useShiftBuffer);

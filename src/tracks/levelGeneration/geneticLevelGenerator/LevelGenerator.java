...
public class LevelGenerator extends AbstractLevelGenerator {
    ...
    /**
     * Get the next population based on the current feasible infeasible
     * population
     * 
     * @param fPopulation
	...
	// if the population is infeasible use the constraintRoulletWheel
	// function
    ...
    /**
     * Generate a level using GA in a fixed amount of time and return the level
     * in form of a string
     * 
     * @param game
	...
	for (int i = 0; i < SharedData.POPULATION_SIZE; i++) {
	    ...
	    // initialize the population using either randomly or using
	    // contructive level generator
	    ...
	    // calculate the fitness for all the chromosomes and add them to the
	    // correct population
	...
	while (elapsedTimer.remainingTimeMillis() > 2 * avgTime && elapsedTimer.remainingTimeMillis() > worstTime) {
	    ...
	    // get the new population and split it to a the feasible and
	...
	// return the best feasible chromosome otherwise and print some
	// statistics

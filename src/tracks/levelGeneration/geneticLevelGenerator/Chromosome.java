...
public class Chromosome implements Comparable<Chromosome> {
    ...
    /**
     * Fix the player in the level (there must be only one player no more or
     * less)
     */
     ...
     * 
     * @return Level mapping object that can help to construct the level string
     *         and parse the level string
     */
	...
	// modify the hashmap to reflect the number of objects found in this
	// level
	for (int y = 0; y < level.length; y++) {
	    for (int x = 0; x < level[y].length; x++) {
    ...
    /**
     * Get fitness value for the current score difference between the best
     * player and the naive player
     * 
     * @param scoreDiff
     *            difference between the best player score and the naive player
     *            score
     * @param maxScore
    ...
    /**
     * check if the player death terminates the game player ID used is 0,
    ...
    /**
     * get a fitness value for the number of unique rules satisfied during
     * playing the game
     * 
     * @param gameState
	...
	if (!calculated) {
	    ...
	    // calculate the maxScore need to be satisfied based on the
	    // difference
	    ...
	    // calculate the constrain fitness by applying all different
	    // constraints
    ...
    /**
     * helpful data structure to hold information about certain points in the
     * level
     * 
     * @author AhmedKhalifa
     */
    ...
    /**
     * Compare two chromosome with each other based on their constrained fitness
     * and normal fitness
     */
    @Override

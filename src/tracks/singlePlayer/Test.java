...
public class Test {
	...
	String randomRuleGenerator = "tracks.ruleGenerators.randomRuleGenerator.RuleGenerator";
	String constructiveRuleGenerator = "tracks.ruleGenerators.constructiveRuleGenerator.RuleGenerator";

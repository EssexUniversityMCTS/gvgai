...
public class WallStop extends Effect {
	...
	public void execute(VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
		...
		double centerXDiff = Math.abs(sprite1.rect.getCenterX()
				- sprite2.rect.getCenterX());
		double centerYDiff = Math.abs(sprite1.rect.getCenterY()
				- sprite2.rect.getCenterY());

		double friction = 0.0;
		sprite1.orientation = centerXDiff > centerYDiff ? new Vector2d(0,
				sprite1.orientation.y * (1.0 - friction)) : new Vector2d(
				sprite1.orientation.x * (1.0 - friction), 0);

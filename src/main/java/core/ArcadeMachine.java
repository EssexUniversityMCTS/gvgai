...
public final class ArcadeMachine {
	 ...
	 */
	public static double playOneGame(String game_file, String level_file,
	 ...
	 */
	public static double runOneGame(String game_file, String level_file,
			boolean visuals, String agentName, String actionFile, int randomSeed) {
		VGDLFactory.GetInstance().init(); // This always first thing to do.
		VGDLRegistry.GetInstance().init();

		System.out.println(" ** Playing game " + game_file + ", level "
				+ level_file + " **");
	 ...
	 *            true to show the graphics, false otherwise.
	 * @param actionFile
	 *            name of the file where the actions of this player, for this
	 ...
	 *         game.
	 */
	private static AbstractPlayer createPlayer(String playerName,

...
public class VGDLRegistry {
	...
	public static VGDLRegistry GetInstance() {
		if (null == VGDLRegistry.registry) {
			VGDLRegistry.registry = new VGDLRegistry();
			VGDLRegistry.registry.init();
		}
		return VGDLRegistry.registry;
	}
	...
	/**
	 * Returns the String associated with the first (and in theory, unique)
	 * sprite value passed. This method is for <b>debug purposes only</b>,
	 * should not be used for game execution.
	 * 
	 * @param value
	...
	public String getRegisteredSpriteKey(int value) {
		...
		System.out
				.println("This method is deprecated, should not be used (other than debug).");

...
public class SharedData {
	 ...
	 */
	public static final String AGENT_NAME = "controllers.singlePlayer.tools.repeatOLETS.Agent";
	/**
	 * The name of a naive agent
	 */
	public static final String NAIVE_AGENT_NAME = "controllers.singlePlayer.simple.sampleonesteplookahead.Agent";
	/**
	 * The name of the do nothing agent
	 */
	public static final String DO_NOTHING_AGENT_NAME = "controllers.singlePlayer.simple.doNothing.Agent";

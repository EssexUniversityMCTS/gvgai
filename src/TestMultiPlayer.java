...
//		"trainride", "treasuremap", "upgrade-x", "warzone", "wheelme" }; // 5-9
	...
	// + k + ".txt";
	// }
	// ArcadeMachine.runGames(game, levels, M, controllers, saveActions?
	// actionFiles:null);
	// }

	// 6. This plays a round robin style tournament between multiple
	// controllers, in N games, first L levels, M times each.
	...
	// sampleMCTSController, sampleOLMCTSController}; //add all controllers
